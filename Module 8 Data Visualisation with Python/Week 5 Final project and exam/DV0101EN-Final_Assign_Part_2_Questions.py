...
def update_output_container(dropdown_statistics, selected_year):
...
# Yearly Statistic Report Plots                             
    elif (selected_year and dropdown_statistics=='Yearly Statistics') :
...
# Plot 2 Total Monthly Automobile sales using line chart
        Y_chart2 = dcc.Graph(figure=px.line(yearly_data,
                                            x='Month',
                                            y='Automobile_Sales',
                                            title=f'Total montly automobile sales in the year {selected_year}'))
...
# Plot 4 Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(figure=px.pie(exp_data,
                                           names='Vehicle_Type', 
                                           values='Advertising_Expenditure', 
                                           title=f'Advertising expenditure by vehicle type in the year {selected_year}'))
